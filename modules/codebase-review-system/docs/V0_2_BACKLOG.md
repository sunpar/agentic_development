...
- Remaining follow-up: add opt-in commit, PR, review-request, and merge automation for implementation-wave task branches after Codex execution has been dogfooded.
