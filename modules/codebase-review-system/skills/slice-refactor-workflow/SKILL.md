---
name: slice-refactor-workflow
description: Use after slice-review-workflow, when applying valid findings and simplifying code.
---
...
Use after slice-review-workflow, when applying valid findings and simplifying code.
