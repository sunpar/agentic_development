---
name: slice-wave-planner
description: Use after slice generation to determine parallel waves.
---
...
Use after slice generation to determine parallel waves.
...
- references/wave-rules.md
- references/parallel-safety-rules.md
