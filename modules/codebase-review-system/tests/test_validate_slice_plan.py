...
class TestSlicePlan(unittest.TestCase):
    ...
    def test_schema_encodes_validator_constraints(self):
        ...
        self.assertIn('allOf', slice_schema)
        self.assertIn('tests_to_read', json.dumps(slice_schema['allOf']))
        ...
        self.assertIn('[Mm][Aa][Ii][Nn]', branch_pattern)
        ...
        self.assertIsNone(re.match(branch_pattern, 'Main'))
        self.assertIsNone(re.match(branch_pattern, 'MASTER'))
